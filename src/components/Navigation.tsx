...
import { Menu, Home, Building, Building2, MapPin, Truck, ShoppingBag, User, Settings, LogOut, Shield } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            <span className="text-xl font-bold text-primary">Masskan Rima</span>
          </Link>
                      ...
                      {isModerator && (
                        <DropdownMenuItem asChild>
                          <Link to="/admin/moderator" className="cursor-pointer">
                            <Shield className="mr-2 h-4 w-4" />Moderator Dashboard
                          </Link>
                        </DropdownMenuItem>
                      )}
                    </>
