...
import samuelCeoImg from "@/assets/team/samuel-karanja-ceo.jpg";
import brianCfoImg from "@/assets/team/brian-ndungu-cfo.jpeg";
import brianCooImg from "@/assets/team/brian-cheruiyot-coo.jpeg";
  ...
  const team = [
    {
      ...
      image: samuelCeoImg,
      description: "Visionary leader driving Masskan Rima's mission to transform property services in Kenya."
    },
    {
      name: "Brian Ndung'u",
    ...
    },
    {
      ...
      image: brianCooImg,
      description: "Operations expert streamlining processes for exceptional customer experiences."
    }
  ];
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Our dedicated leadership team brings together decades of experience in technology, real estate, and customer service.
          </p>
