                        ...
                        {bookings.map((booking) => (
                          <div key={booking.id} className="p-4 border rounded-lg flex items-start gap-4 hover:bg-muted/50 transition-colors">
                            <div className="w-16 h-16 rounded-lg bg-muted flex-shrink-0">
                              {booking.property?.image && <img src={booking.property.image} alt={booking.property.title} className="w-full h-full object-cover object-center brightness-110 rounded-lg" />}
                            </div>
                      ...
                      <div className="space-y-4">
                        {purchases.map((purchase) => (
                          <div key={purchase.id} className="p-4 border rounded-lg flex items-start gap-4 hover:bg-muted/50 transition-colors">
                            <div className="w-16 h-16 rounded-lg bg-muted flex-shrink-0">
                              {purchase.item?.image && <img src={purchase.item.image} alt={purchase.item.title} className="w-full h-full object-cover object-center brightness-110 rounded-lg" />}
                            </div>
                            <div className="flex-grow">
                      ...
                      <div className="space-y-4">
                        {quotes.map((quote) => (
                          <div key={quote.id} className="p-4 border rounded-lg flex items-start gap-4 hover:bg-muted/50 transition-colors">
                            <div className="w-16 h-16 rounded-lg bg-muted flex-shrink-0">
                              {quote.service?.image && <img src={quote.service.image} alt={quote.service.name} className="w-full h-full object-cover object-center brightness-110 rounded-lg" />}
                            </div>
                            <div className="flex-grow">
