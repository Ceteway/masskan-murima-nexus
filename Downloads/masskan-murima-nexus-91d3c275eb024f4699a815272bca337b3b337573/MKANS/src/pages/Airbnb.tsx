...
const Airbnb = () => {
  ...
  const properties = [
    ...
    },
    {
      ...
      bathrooms: 2,
      area: 1800,
      images: ["https://images.unsplash.com/photo-1493397212122-2b85dda8106b?w=400&h=300&fit=crop"],
      type: "airbnb" as const,
      featured: true
    },
    {
    ...
    {
      id: "kilimani-1",
      title: "Beautiful Kilimani Apartment",
      location: "Kilimani, Nairobi",
      price: 5000,
      priceType: "night" as const,
      rating: 4.5,
      ...
      bathrooms: 1,
      area: 600,
      images: ["/kilimani 1.jpeg", "/kilimani 2.jpeg", "/kilimani 3.jpeg", "/kilimani 4.jpeg", "/kilimani 5.jpeg", "/kilimani 6.jpeg"],
      type: "airbnb" as const
    },
    {
      id: "meru-1",
      title: "Scenic Meru Accommodation",
      location: "Meru, Kenya",
      price: 5000,
      priceType: "night" as const,
      rating: 4.3,
      ...
      bathrooms: 1,
      area: 700,
      images: ["/Meru 1.jpeg", "/Meru 2.jpeg", "/Meru 3.jpeg", "/Meru 4.jpeg", "/Meru.jpeg"],
      type: "airbnb" as const
    },
    {
      id: "nkubu-chuka-1",
      title: "Cozy Nkubu Chuka Stay",
      location: "Nkubu, Chuka, Kenya",
      price: 5000,
      priceType: "night" as const,
      rating: 4.2,
      reviews: 12,
      ...
      bathrooms: 1,
      area: 500,
      images: ["/Nkubu Chuka 1.jpeg", "/Nkubu chuka 2.jpg", "/Nkubu,Chuka 3.jpeg"],
      type: "airbnb" as const
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {properties.map((property) => (
              <PropertyCard
                key={property.id}
                {...property}
                onBookNow={() => handleBookNow(property)}
              />
            ))}
          </div>
        </div>
